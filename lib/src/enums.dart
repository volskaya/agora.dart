...
enum AreaCode {
  @JsonValue(0x00000001) china,
  @JsonValue(0x00000002) northAmerica,
  @JsonValue(0x00000004) europe,
  @JsonValue(0x00000008) asia,
  @JsonValue(0x00000010) japan,
  @JsonValue(0x00000020) india,
  @JsonValue(-1) global,
}
...
enum AudioOutputRouting {
  ...
  /// Earpiece.
  @JsonValue(1) earpiece,

  /// Headset with no microphone.
  @JsonValue(2) headsetNoMic,

  /// Speakerphone.
  @JsonValue(3) speakerphone,

  /// Loudspeaker.
  @JsonValue(4) loudspeaker,

  /// Bluetooth headset.
  @JsonValue(5) headsetBluetooth,
}
...
enum AudioRemoteStateReason {
  /// Internal reasons.
  @JsonValue(0) internal,

  /// Network congestion.
  @JsonValue(1) networkCongestion,

  /// Network recovery.
  @JsonValue(2) networkRecovery,

  /// The local user stops receiving the remote audio stream or disables the audio module.
  @JsonValue(3) localMuted,

  /// The local user resumes receiving the remote audio stream or enables the audio module.
  @JsonValue(4) localUnmuted,

  /// The remote user stops sending the audio stream or disables the audio module.
  @JsonValue(5) remoteMuted,

  /// The remote user resumes sending the audio stream or enables the audio module.
  @JsonValue(6) remoteUnmuted,

  /// The remote user leaves the channel.
  @JsonValue(7) remoteOffline,
}

/// The preset local voice reverberation option.
enum AudioReverbPreset {
  /// Turn off local voice reverberation, that is, to use the original voice.
  @JsonValue(0x00000000) off,

  /// The reverberation style typical of popular music (enhanced).
  @JsonValue(0x00000001) popular,

  /// The reverberation style typical of R&B music (enhanced).
  @JsonValue(0x00000002) rnB,

  /// The reverberation style typical of rock music.
  @JsonValue(0x00000003) rock,

  /// The reverberation style typical of hip-hop music.
  @JsonValue(0x00000004) hipHop,

  /// The reverberation style typical of a concert hall.
  @JsonValue(0x00000005) vocalConcert,

  /// The reverberation style typical of a KTV venue (enhanced).
  @JsonValue(0x00000006) ktv,

  /// The reverberation style typical of a recording studio (enhanced).
  @JsonValue(0x00000007) studio,

  /// The reverberation style typical of a KTV venue (enhanced).
  @JsonValue(0x00100001) fxKtv,

  /// The reverberation style typical of a concert hall (enhanced).
  @JsonValue(0x00100002) fxVocalConcert,

  /// The reverberation style typical of an uncle’s voice.
  @JsonValue(0x00100003) fxUncle,

  /// The reverberation style typical of a sister’s voice.
  @JsonValue(0x00100004) fxSister,

  /// The reverberation style typical of a recording studio (enhanced).
  @JsonValue(0x00100005) fxStudio,

  /// The reverberation style typical of popular music (enhanced).
  @JsonValue(0x00100006) fxPopular,

  /// The reverberation style typical of R&B music (enhanced).
  @JsonValue(0x00100007) fxRnb,

  /// The reverberation style typical of the vintage phonograph.
  @JsonValue(0x00100008) fxPhonograph,
...
enum AudioVoiceChanger {
  ...
  @JsonValue(0x00000001) oldMan,

  /// The voice of a little boy.
  @JsonValue(0x00000002) babyBoy,

  /// The voice of a little girl.
  @JsonValue(0x00000003) babyGirl,

  /// The voice of Zhu Bajie, a character in Journey to the West who has a voice like that of a growling bear.
  @JsonValue(0x00000004) zhuBaJie,

  /// The ethereal voice.
  @JsonValue(0x00000005) ethereal,

  /// The voice of Hulk.
  @JsonValue(0x00000006) hulk,

  /// A more vigorous voice.
  @JsonValue(0x00100001) beautyVigorous,

  /// A deeper voice.
  @JsonValue(0x00100002) beautyDeep,

  /// A mellower voice.
  @JsonValue(0x00100003) beautyMellow,

  /// Falsetto.
  @JsonValue(0x00100004) beautyFalsetto,

  /// A fuller voice.
  @JsonValue(0x00100005) beautyFull,

  /// A clearer voice.
  @JsonValue(0x00100006) beautyClear,

  /// A more resounding voice.
  @JsonValue(0x00100007) beautyResounding,

  /// A more ringing voice.
  @JsonValue(0x00100008) beautyRinging,

  /// A more spatially resonant voice.
  @JsonValue(0x00100009) beautySpacial,

  /// (For male only) A more magnetic voice. Do not use it when the speaker is a female; otherwise, voice distortion occurs.
  @JsonValue(0x00200001) generalBeautyVoiceMaleMagnetic,

  /// (For female only) A fresher voice. Do not use it when the speaker is a male; otherwise, voice distortion occurs.
  @JsonValue(0x00200002) generalBeautyVoiceFemaleFresh,

  /// (For female only) A more vital voice. Do not use it when the speaker is a male; otherwise, voice distortion occurs.
  @JsonValue(0x00200003) generalBeautyVoiceFemaleVitality,
}
...
enum ErrorCode {
  ...
  @JsonValue(17) joinChannelRejected,
  ...
  @JsonValue(18) leaveChannelRejected,

  /// The resources are occupied and cannot be used.
  @JsonValue(19) alreadyInUse,
  ...
  @deprecated @JsonValue(109) tokenExpired,
  ...
  @JsonValue(151) publishStreamCDNError,

  /// The host publishes more than 10 URLs. Delete the unnecessary URLs before adding new ones.
  @JsonValue(152) publishStreamNumReachLimit,

  /// The host manipulates other hosts' URLs. Check your app logic.
  @JsonValue(153) publishStreamNotAuthorized,
  ...
  @deprecated @JsonValue(1003) startCamera,

  /// Fails to start the video rendering module.
  @JsonValue(1004) startVideoRender,
  ...
  @JsonValue(1005) admGeneralError,
...
enum NetworkQuality {
  ...
  @JsonValue(7) unsupported,

  /// Detecting the network quality.
  @JsonValue(8) detecting,
}
...
enum NetworkType {
  ...
  @JsonValue(3) mobile2G,

  /// The network type is mobile 3G.
  @JsonValue(4) mobile3G,

  /// The network type is mobile 4G.
  @JsonValue(5) mobile4G,
}
...
enum VideoOutputOrientationMode {
  ...
  @JsonValue(2) fixedPortrait,
}

/// Quality change of the local video in terms of target frame rate and target bit rate since last count.
enum VideoQualityAdaptIndication {
  /// The quality of the local video stays the same.
  @JsonValue(0) adaptNone,

  /// The quality improves because the network bandwidth increases.
  @JsonValue(1) adaptUpBandwidth,

  /// The quality worsens because the network bandwidth decreases.
  @JsonValue(2) adaptDownBandwidth,
}
...
enum VideoRenderMode {
  ...
  /// This mode is deprecated.
  @deprecated @JsonValue(3) adaptive,
...
enum WarningCode {
  ...
  @JsonValue(104) lookupChannelTimeout,
  ...
  ///
  ///
  @JsonValue(1029) admCategoryNotPlayAndRecord,

  /// Audio Device Module: the recorded audio is too low.
  @JsonValue(1031) admRecordAudioLowlevel,

  /// Audio Device Module: the playback audio is too low.
  @JsonValue(1032) admPlayoutAudioLowlevel,

  /// Audio Device Module: The recording device is busy.
  @JsonValue(1033) admRecordIsOccupied,
  ...
  ///
  ///
  @JsonValue(1040) admNoDataReadyCallback,
...
enum StreamPublishState {
  ...
  @JsonValue(1) noPublished,

  /// Publishing.
  @JsonValue(2) publishing,

  /// Publishes successfully.
  @JsonValue(3) published,
}
...
enum AudioSessionOperationRestriction {
  ...
  @JsonValue(1) setCategory,

  /// The SDK does not change any setting of the audio session (category, mode, categoryOptions).
  @JsonValue(1 << 1) configureSession,

  /// The SDK keeps the audio session active when leaving a channel.
  @JsonValue(1 << 2) deactivateSession,
...
enum AudioEffectPreset {
  ...
  @JsonValue(0x00000000) audioEffectOff,

  /// An audio effect typical of a KTV venue.
  @JsonValue(0x02010100) roomAcousticsKTV,
  ...
  @JsonValue(0x02010200) roomAcousticsVocalConcert,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02010300) roomAcousticsStudio,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02010400) roomAcousticsPhonograph,
  ...
  @JsonValue(0x02010500) roomAcousticsVirtualStereo,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02010600) roomAcousticsSpacial,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02010700) roomAcousticsEthereal,
  ...
  @JsonValue(0x02010800) roomAcoustics3DVoice,
  ...
  /// - To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020100) voiceChangerEffectUncle,
  ...
  /// - Agora recommends using this enumerator to process a male-sounding voice; otherwise, you may not hear the anticipated voice effect.
  /// - To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020200) voiceChangerEffectOldMan,
  ...
  /// - Agora recommends using this enumerator to process a male-sounding voice; otherwise, you may not hear the anticipated voice effect.
  /// - To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020300) voiceChangerEffectBoy,
  ...
  /// - To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020400) voiceChangerEffectSister,
  ...
  /// - Agora recommends using this enumerator to process a male-sounding voice; otherwise, you may not hear the anticipated voice effect.
  /// - To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020500) voiceChangerEffectGirl,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020600) voiceChangerEffectPigKing,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02020700) voiceChangerEffectHulk,
  ...
  @JsonValue(0x02030100) styleTransformationRnB,
  ...
  ///
  /// Call [RtcEngine.setAudioProfile] and set the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator; otherwise, the enumerator setting does not take effect.
  @JsonValue(0x02030200) styleTransformationPopular,
  ...
  ///
  /// To achieve better audio effect quality, Agora recommends calling [RtcEngine.setAudioProfile] and setting the profile parameter to `MusicHighQuality(4)` or `MusicHighQualityStereo(5)` before setting this enumerator.
  @JsonValue(0x02040100) pitchCorrection,
}

/// The options for SDK preset voice beautifier effects.
enum VoiceBeautifierPreset {
  /// Turn off voice beautifier effects and use the original voice.
  @JsonValue(0x00000000) voiceBeautifierOff,
  ...
  @JsonValue(0x01010100) chatBeautifierMagnetic,

  /// A fresher voice.
  ///
  /// Agora recommends using this enumerator to process a female-sounding voice; otherwise, you may experience vocal distortion.
  @JsonValue(0x01010200) chatBeautifierFresh,

  /// A more vital voice.
  ///
  /// Agora recommends using this enumerator to process a female-sounding voice; otherwise, you may experience vocal distortion.
  @JsonValue(0x01010300) chatBeautifierVitality,

  /// A more vigorous voice.
  @JsonValue(0x01030100) timbreTransformationVigorous,

  /// A deeper voice.
  @JsonValue(0x01030200) timbreTransformationDeep,

  /// A mellower voice.
  @JsonValue(0x01030300) timbreTransformationMellow,

  /// A falsetto voice.
  @JsonValue(0x01030400) timbreTransformationFalsetto,

  /// A fuller voice.
  @JsonValue(0x01030500) timbreTransformationFull,

  /// A clearer voice.
  @JsonValue(0x01030600) timbreTransformationClear,

  /// A more resounding voice.
  @JsonValue(0x01030700) timbreTransformationResounding,

  /// A more ringing voice.
  @JsonValue(0x01030800) timbreTransformationRinging,
}
...
enum AudienceLatencyLevelType {
  /// 1: Low latency.
  @JsonValue(1) lowLatency,

  /// 2: (Default) Ultra low latency.
  @JsonValue(2) ultraLowLatency,
}
